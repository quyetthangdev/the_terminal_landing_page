    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          ...
          {/* Glass label overlay */}
          <div className="absolute bottom-4 left-4 bg-white/70 backdrop-blur-md border border-gold/20 px-4 py-3 rounded-sm">
            <p className="text-brand-dark/60 text-[10px] tracking-[0.3em]">THE TERMINAL</p>
            <p className="text-gold text-xs font-semibold tracking-wider">CAFE & EUROPEAN KITCHEN</p>
          </div>
        </div>

        {/* Glass content card */}
        <div className="bg-white/70 backdrop-blur-md border border-gold/15 shadow-sm rounded-sm p-8 md:p-10">
          ...
          <p className="text-brand-dark/40 text-sm leading-relaxed">
