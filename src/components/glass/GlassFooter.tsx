...
export default function GlassFooter() {
  return (
    <footer className="py-12 bg-pearl border-t border-gold/20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-display font-bold text-brand-dark tracking-[0.3em] text-sm">THE TERMINAL</p>
            <p className="text-brand-dark/40 text-[10px] tracking-widest mt-1">CAFE & EUROPEAN KITCHEN</p>
          </div>
          ...
          <p className="text-brand-dark/30 text-[10px] tracking-widest">© 2026 THE TERMINAL. ALL RIGHTS RESERVED.</p>
        </div>
      </div>
    </footer>
  )
